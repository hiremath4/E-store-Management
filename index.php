...
<head>
  ...
  <title>E-store Landing Page</title>
  <?php 
    require "header.php"; 
...
<body>
  <div class="slider" style="width: 60%; margin: auto;">
    <ul class="slides">
      ...
      <li>
        ...
        <div class="caption center-align">
          <h3 class="bold page-title">At E-Store </h3>
  ...
  <div class="section" style="margin-top: 100px;">
    <div class="wide-container">
      ...
      <h5 class="white-text center">
        At <b class="orange-text">E-store Tech PC</b>, We are a team of serious gamers and overclockers with a passion towards customized and fast PCs.
      </h5>
    </div>
  </div>
  ...
  <div class="grid" style="margin-top: 20px; margin-bottom: 100px">
    <div class="grid">
      <h1 class="count red-text text-darken-4 bold center">1</h1>
      <h5 class="white-text center">Year Of History</h5>
    </div>
    <div class="grid">
      <h1 class="count red-text text-darken-4 bold center">1000</h1>
  ...
  <h3 class="white-text center">E-Store - White PC Build</h3>
