<footer class="page-footer" style="margin-top: 120px; box-shadow: 0px 0px 2px white; background-color: rgb(17,17,17)">
  <div class="row wide-container">
    <div class="col s3">
      <h4 class="white-text bold underline">E-Store</h4>
    ...
    <div class="col s2">
      ...
      <p class="bold">
        Hukkeri,Belagavi <br>
        karnataka, 591309<br> HSIT Nidasoshi
      </p>
    </div>
    <div class="col s2">
  ...
  <div class="footer-copyright" style="padding-bottom: 20px;">
    <div class="wide-container underline">© 2024 E-Store All rights reserved.</div>
  </div>
