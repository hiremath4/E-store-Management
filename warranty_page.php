...
<html>
<head>
<title>Warranty Info - E-store</title>
...
<p class="text">w/ Warranty Info</p>
</div>
...
<div class="textbox">
	...
	<ul style="list-style:none;content:bullet;color:white">
		...
		<br><li class="text">Shipping and service charges may be applicable IF hardware tested non faulty and / or caused by hardware not purchased from E-store, 
			the final decision lies with the staffs of E-store.</li>
		<br><li class="text">Please take note that The FREE PICKUP AND RETURN SERVICES covers all the products purchased from E-store and is still under warranty only.</li>
